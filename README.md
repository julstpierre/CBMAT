...
<!-- You can install the released version of CBMAT from [CRAN](https://CRAN.R-project.org) with: -->
    ...
    #> Installing package into 'C:/Users/Julien/AppData/Local/Temp/Rtmpe2pt2n/temp_libpath283c79bf3141'
    #> (as 'lib' is unspecified)
    #> Warning: package 'CBMAT' is not available (for R version 4.0.2)
